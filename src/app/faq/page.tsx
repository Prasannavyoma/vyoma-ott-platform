      ...
      <div style={{ padding: '120px 5% 50px', maxWidth: '1000px', margin: '0 auto', color: 'white' }}>
        ...
        <div style={{ textAlign: 'center', marginTop: '60px', padding: '30px', background: 'rgba(255, 215, 0, 0.05)', borderRadius: '12px', border: '1px solid rgba(255, 215, 0, 0.2)' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '15px', flexWrap: 'wrap' }}>
            ...
            <a href="mailto:support@vyoma.org" target="_blank" rel="noopener noreferrer" className="btn" style={{ background: '#3b82f6', color: 'white', padding: '12px 25px', borderRadius: '8px', fontWeight: 'bold', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '8px' }}>
